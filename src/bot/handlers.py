...
Мы работаем над созданием максимально стабильной системы обхода DPI-блокировок.

<b>✨ Что будет доступно:</b>
✅ Работа при активных блокировках DPI
✅ Стабильное соединение 24/7
✅ WhatsApp, Telegram, Instagram - всегда онлайн
✅ Новейший протокол XHTTP + Reality
✅ Специальная маскировка трафика

<b>📅 Когда запустим:</b>
После финальных тестов на скорость и стабильность. Следите за обновлениями!

<b>💡 Пока рекомендуем:</b>
Используйте обычный VPN - он уже работает быстро и стабильно!
...
async def antiblock_info(callback: CallbackQuery):
    ...
    info_text = """
🛡️ <b>Что такое "Обход глушилок"?</b>

🚧 <b>Статус:</b> В разработке

Это будет специальная версия VPN с усиленной защитой от блокировок DPI.
...
✅ WhatsApp, Telegram, Instagram - всегда онлайн
✅ Новейший протокол XHTTP + Reality
✅ Специальная маскировка под легитимный трафик
...
<b>Антиглушилка (скоро):</b>
• Максимальная стабильность при блокировках
• Работает даже при жёстких DPI-блокировках
• Премиум-защита

<b>🔔 Мы уведомим вас когда функция будет доступна!</b>

Пока рекомендуем обычный VPN - он уже работает отлично! 🚀
"""
...
async def admin_test_antiblock(callback: CallbackQuery):
    ...
    if vpn_data:
        ...
        text = (
            "✅ <b>Тестовый VPN создан!</b>\n\n"
            "🛡️ <b>Режим:</b> Обход глушилок (Reality)\n"
            "📅 <b>Срок:</b> 30 дней\n"
            "💾 <b>Трафик:</b> 100 GB\n\n"
            "🔗 <b>Ваш VPN-ключ:</b>\n"
            f"<code>{vpn_data['subscription_url']}</code>\n\n"
            ...
            "3. Нажмите '+' → 'Import from clipboard'\n"
            "4. Подключитесь к серверу!\n\n"
            "🔥 <b>Обходит DPI-глушилки! Работает с WhatsApp, Instagram, Telegram даже при блокировках!</b>\n\n"
            "❓ Вопросы? Пишите @tipss94"
        )
        await callback.message.answer(text, parse_mode="HTML")
        await callback.message.edit_text(
